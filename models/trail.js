...
const trailSchema = new mongoose.Schema({
  ...
  reviews: [reviewSchema], // One Trail HAS MANY reviews, Using embedding in Mongoose
  distance: String,
...
// 1. Creates a collection (The bucket) in mongodb named trails, and it says that all the trail Documents
